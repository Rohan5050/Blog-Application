    ...
    <nav>
      <div className="container nav_container">
        ...
        {isNavShowing && <ul className='nav_menu'>
          <li><Link id='nav-style' to="/profile/sdfsdf"onClick={closeNavHandler}>Profile</Link></li>
          <li><Link id='nav-style' to="/create"onClick={closeNavHandler}>Create Post</Link></li>
          <li><Link id='nav-style' to="/authors" onClick={closeNavHandler}>Authors</Link></li>
